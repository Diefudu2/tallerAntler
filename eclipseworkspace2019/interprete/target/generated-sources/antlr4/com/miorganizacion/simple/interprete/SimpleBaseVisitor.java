// Generated from com\miorganizacion\simple\interprete\Simple.g4 by ANTLR 4.5.1
...
public class SimpleBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SimpleVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitExponent(SimpleParser.ExponentContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitPrimary(SimpleParser.PrimaryContext ctx) { return visitChildren(ctx); }
}